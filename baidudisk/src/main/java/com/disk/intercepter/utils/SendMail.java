...
public class SendMail {
	 ...
	 * Just do it as this
	 */
	public boolean sendAction(String thetitle, String thebody,
							  String towhoaddress) {

		thebody =
				"<meta http-equiv=Content-Type content=text/html; charset=gb2312>"+
						"<div align=center> "+thebody+"</div>";
	...
	public static void main(String[] args) {
		sendEmailTOQQbox("yangjunnuo@qq.com","您的恒志云盘激活账号","<a href='http://www.baidu.com'>www.baidu.com</a>");
	}
	public static boolean sendEmailTOQQbox(String urlTo,String subject,String content){
		SendMail send = new SendMail();
		return send.sendAction(subject, content, urlTo);
	}
	private static String SiteSmtp = "smtp.qq.com";
	private static String SiteEmailAddress = "yangjunnuo@qq.com";
	private static String SiteEmailUserName = "1355140243";
	private static String SiteEmailPasswd = "xkzklokdvvyphjjj";
}
